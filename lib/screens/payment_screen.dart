    ...
    if (originAccountText.isNotEmpty && amount.isNotEmpty) {
      ...
      if (matches.isNotEmpty) {
        ...
        if (accountBalanceValue >= paymentAmount) {
          // Realizar la lógica de pago o enviar la solicitud a la API
          ApiService.movimiento(originAccount, amount, destinationAccount);
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                // Lógica para generar un código QR con la información de pago
              },
